...
@InputType()
class AffectationCreateNestedManyWithoutStructuresInput {
...
export { AffectationCreateNestedManyWithoutStructuresInput as AffectationCreateNestedManyWithoutStructuresInput };
